...
[![Zaru.png](https://wiki.highfidelity.com/images/thumb/b/b5/Zaru.png/750px-Zaru.png)](https://wiki.highfidelity.com/wiki/File:Zaru.png)
...
[![Hifi-system-architecture.png](https://wiki.highfidelity.com/images/thumb/f/fe/Hifi-system-architecture.png/500px-Hifi-system-architecture.png)](https://wiki.highfidelity.com/wiki/File:Hifi-system-architecture.png)
...
- [Compile from source](https://wiki.highfidelity.com/wiki/Compile_from_source) - You can build each component individually and set-up the assignment client to point to each of the various sub-components.
...
Once you have successfully setup your domain, you’ll need to configure access settings to edit the contents of your server from the Interface client. Follow the instructions in [Introduction to Building in High Fidelity](https://wiki.highfidelity.com/wiki/Introduction_to_Building_in_High_Fidelity) to configure your server settings and add users to your domain with edit privileges.
...
To authenticate and make your domain easier for users to find, you can purchase a [place name](https://wiki.highfidelity.com/wiki/Place_Names) that connects to your domain.
