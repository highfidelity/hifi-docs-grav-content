...
| Your avatar is gray.                                         | One of the following issues could have occurred: <br />A) Make sure you copied your avatar's textures into the project’s textures folder <br /> B) Verify that your textures are in a format that we support (either PNG or JPG)<br /><br />C) If your textures are embedded in your avatar: select the FBX file, go to 'Inspector', and click 'Extract Textures'. Extract your textures into your asset's folder. You can do the same with Materials. |
