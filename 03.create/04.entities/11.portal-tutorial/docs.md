---
title: Tutorial: Create a Portal
taxonomy:
    category: docs
---
...
+ Uses High Fidelity's [JavaScript API](../../../api-reference) to determine when a user walks into the entity and the teleport destination.
